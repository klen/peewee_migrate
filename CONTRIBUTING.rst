...
peewee_migrate could always use more documentation, whether as part of the 
official peewee_migrate docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
.. _Fork: https://github.com/Nekroze/peewee_migrate/fork
...
To run a subset of tests::
	 ...
	 $ py.test test/test_peewee_migrate.py